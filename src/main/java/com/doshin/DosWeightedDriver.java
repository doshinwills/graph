...
import com.doshin.graph.DosDijkstraSearch;
import com.doshin.graph.DosGraph;
...
public class DosWeightedDriver {
	...
	public static void main(String[] args) {
		...
		DosGraph<String> stringGraph = null;
		
//		stringGraph = new DosGraph<String>(false);
//
...
//
//		stringGraph.addEdge("a", "V1", 2);
//
//		DosDijkstraSearch<String> dijkstraSearch = new DosDijkstraSearch<String>(
//				stringGraph);
//
//		System.out.println(dijkstraSearch.dijkstraSearch("V0", "V4"));

		stringGraph = new DosGraph<String>(true);
